...
<body>
    ...
    <div class="banner"
        style="display: flex; align-items: center; justify-content: space-between; background: linear-gradient(rgba(5, 31, 5, 0.6), rgba(24, 73, 24, 0.6)),url('{{ asset('images/banner_categorie.jpg') }}'); background-size: cover; background-position: center; height:80vh">
