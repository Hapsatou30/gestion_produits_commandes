            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    <div class="card text-white  mb-3">
                        <div class="card-header" style="background: #ffb624;text-align: center;">Catégories</div>
                        <div class="card-body" style="background: white; color:#007F01;">
                ...
                <div class="col-md-6">
                    <div class="card text-white  mb-3">
                        <div class="card-header" style="background: #ffb624;text-align: center;">Clients</div>
                        <div class="card-body" style="background: white; color:#007F01;">
                    ...
                    <tbody>
                        @foreach ($produits as $produit)
                            <tr>
                                ...
                                <td>
                                    <a href="/modificationProduit/{{ $produit->id }}" class="btn btn-lg"
                                    ...
                                    <a href="/supprimeProduit/{{ $produit->id }}" class="btn  btn-lg"
                                        style="color: red"
